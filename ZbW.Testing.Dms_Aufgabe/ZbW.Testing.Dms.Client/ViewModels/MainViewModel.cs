...
namespace ZbW.Testing.Dms.Client.ViewModels
{
    public class MainViewModel : BindableBase
    {
        ...
        private void OnCmdNavigateToSearch() => OnNavigateToSearch();
        private void OnCmdNavigateToDocumentDetail() => Content = new DocumentDetailView(Benutzer, OnNavigateToSearch);
        private void OnNavigateToSearch() => Content = new SearchView();
    }
}